...
[SaTd,~    ,pga_rock,pga_sigmaB,pga_tauB] = AS_2008_nga_parallel(M, 1100, Td    , Rrup, Rjb, Rx, dip, Ztor, 0  , width, FRV, FNM, FAS, FHW, FVS30, 0*M ,1);
[Sa  ,sigma,~,~,~,tau,phi]= AS_2008_nga_parallel(M, VS30, To*(M.^0), Rrup, Rjb, Rx, dip, Ztor, Z10, width, FRV, FNM, FAS, FHW, FVS30, SaTd,0,pga_rock,pga_sigmaB,pga_tauB);
lny = log(Sa);
...
if isnan(Rx(1)) || isnan(dip) || isnan(W)
    f4=0;
    return
end
