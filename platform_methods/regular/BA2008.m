...
if T_lo==T_hi
    [lny,sigma,tau,phi] = gmpe(index,M, Rjb, SOF, Vs30);
else
    [lny_lo,sigma_lo,tau_lo] = gmpe(index,  M, Rjb, SOF, Vs30);
    [lny_hi,sigma_hi,tau_hi] = gmpe(index+1,M, Rjb, SOF, Vs30);
    x          = log([T_lo;T_hi]);
    Y_sa       = [lny_lo,lny_hi]';
...
switch SOF
    ...
    case 'normal'          , N=1;
    case 'normal-oblique'  , N=1;
    case 'reverse'         , R=1;
    case 'reverse-oblique' , R=1;
