function[lny,sigma,tau,phi]=Jaimes2018(To,M,rrup,adjfun)
...
if T_lo==T_hi
    [lny,sigma,tau] = gmpe(index,M,rrup);
...
% unit convertion
lny  = lny-log(980.66);% unit convertion
...
function [lny,sigma,tau]=gmpe(index,M,rrup)
